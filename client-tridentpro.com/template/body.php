<body class="body-padding body-p-top light-theme">
    ...
    <div class="main-content">
        ...
        switch($pageFile) {
            ...
            default: 
                ...
                file_exists($dir."/".$pageFile.".php") 
                    ? include $dir."/".$pageFile.".php"
                    : include $dir."/"."404.php";
                break;
        }
        ?>
    ...
    <div class="ini-modal-file">
        ...
        // nama harus diawali modal-
            if(file_exists($dir . "/modal/modal-" . $login_page . ".php")) {
                include $dir . "/modal/modal-" . $login_page . ".php";
            }
