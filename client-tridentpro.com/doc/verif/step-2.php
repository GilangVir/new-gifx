                    ...
                    <form action="" method="POST" id="form-step-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4" mb-2>
                                ...
                                <input type="date" name="date_of_birth" id="date_of_birth" max="<?php echo date("Y-m-d") ?>" class="form-control" value="<?php echo $user['MBR_TGLLAHIR'] ?? ""; ?>" placeholder="Date of birth" required>
                            </div>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="number" name="no_idt" class="form-control" value="<?php echo $user['MBR_NO_IDT'] ?? ""; ?>" placeholder="NIK" required>
                            </div>

                            <div class="col-md-6 mb-2">
                                <label for="ktp_photo" class="form-label required">KTP photo</label>
                                <input type="file" class="dropify" name="ktp_photo" id="ktp_photo" <?= (!empty($user['MBR_FILE_KTP']))? 'data-default-file="'.($aws_folder . $user['MBR_FILE_KTP']).'"' : ""; ?> data-min-width="480" data-min-height="640" data-max-file-size="2M" ata-allowed-file-extensions="png jpg jpeg">
                            </div>

                            <div class="col-md-6 mb-2">
                                <label for="selfie_photo" class="form-label required">Selfie photo</label>
                                <input type="file" class="dropify" name="selfie_photo" id="selfie_photo" <?= (!empty($user['MBR_FILE_SELFIE']))? 'data-default-file="'.($aws_folder . $user['MBR_FILE_SELFIE']).'"' : ""; ?> data-min-width="480" data-min-height="640" data-max-file-size="4M" ata-allowed-file-extensions="png jpg jpeg">
                            </div>
