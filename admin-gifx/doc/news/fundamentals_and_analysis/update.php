...
if (!$nilai) {
    die('<script>alert("id not found"); location.href = "/news/fundamentals_and_analysis/view"</script>');
}
        ...
        <div class="col mb-3 mt-5">
            <div class="card">
                <div class="card-header">
                    <h1>Fundamentals and analysis</h1>
                    <div class="card-body">
                        <form id="fundamen">
...
<script class="text/javascript">
    ...
    $(document).ready(function(){
        $('#fundamen').on('submit', function(e){
            ...
            $.ajax({
                url: '/ajax/post/news/fundamentals_and_analysis/update',
                type: 'POST',
                dataType: 'json',
                contentType: false,
                processData: false,
                ...
                success: function(response) {
                    ...
                    setTimeout(function(){
                        location.href = "/news/fundamentals_and_analysis/view";
                    }, 500);
                },
            });
        })
