                    ...
                    <tbody>
                        <tr>
                            ...
                            <div align="center" style="font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif;text-align:center">
                                ...
                                <tbody>
                                    <tr>
                                    <td align="center" valign="middle" style="padding:0px;margin:0px;font-size:0px;width:56px">
                                        <img alt="" width="56" height="61" style="display:block;border:0;outline:none;text-decoration:none" src="https://ci3.googleusercontent.com/meips/ADKq_NbRF5OAHNNH37D062PDX6ZUsgdn1gr8wbkKDeHI7U038cDk_xxLEkCiRLDKBWuNUdT6o7rKTgEFhcqWjv9bB6mkeBv48THloYgVwAQUR9XqDnlvp2DjM4PI7pCChUxt5sAU2Eo3O8uz0t20psyUocOMXACqOXeDMx5l3sKQDdemXgb5cEvdDKS0pOp1c7COth8ds3E5Qe_yRVCwshA=s0-d-e1-ft#https://kivys.stripocdn.email/content/guids/CABINET_ad45b490c09265f65aa37c74ea0f4b2962d4ca4c6dbd5c0f21862ef41b8994ee/images/letter.png" class="CToWUd" data-bit="iit">
                                    </td>
                                    </tr>
                                </tbody>
                                </table>
                        ...
                        <tr>
                            <td>
                                <div style="color:#0b0b16;direction:ltr;font-family:Roboto,Tahoma,Verdana,Segoe,sans-serif;font-size:16px;font-weight:400;letter-spacing:0;line-height:150%;text-align:center">
                                    <p style="margin:0">To continue reset password for your account, Please continue by clicking the button below</p>
                                </div>
                            </td>
                        </tr>
                    </tbody>
                                                                    ...
                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation">
                                                                        <tbody>
                                                                            ...
                                                                            <td style="text-align:center">
                                                                                <div align="center">
                                                                                    <a href="https://my.gfsprime.com/reset/<?= $code ?>" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#0c34f0;border-radius:30px;width:auto;border-top:0px solid transparent;font-weight:400;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:16px;padding-bottom:16px;font-family:Arial,Helvetica Neue,Helvetica,sans-serif;text-align:center;word-break:keep-all" target="_blank">
                                                                                        <span style="padding-left:48px;padding-right:48px;font-size:16px;display:inline-block;letter-spacing:normal">
                                                                                        <span dir="ltr" style="word-break:break-word;line-height:19.2px">Reset</span>
                                                                                        </span>
                                                                                    </a>
                                                                                </div>
                                                                            </td>
